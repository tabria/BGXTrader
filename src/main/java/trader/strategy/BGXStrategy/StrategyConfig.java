...
public class StrategyConfig {
    ...
    public static String[] PRICE_SMA_SETTINGS = {"1", "CLOSE", "SIMPLE"};
    public static String[] DAILY_SMA_SETTINGS = {"1", "OPEN", "SIMPLE"};
    public static String[] FAST_WMA_SETTINGS = {"5", "CLOSE", "WEIGHTED"};
    public static String[] MIDDLE_WMA_SETTINGS = {"20", "CLOSE", "WEIGHTED"};
    public static String[] SLOW_WMA_SETTINGS = {"100", "CLOSE", "WEIGHTED"};
    public static String[] RSI_SETTINGS = {"14", "CLOSE"};
