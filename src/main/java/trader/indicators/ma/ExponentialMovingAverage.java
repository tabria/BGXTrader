...
public final class ExponentialMovingAverage extends BaseMovingAverage {
     ...
     * {@code
     * Initial SMA take extra (candlesticksQuantity) prices from the first price for the candlesticksQuantity.
    ...
    private void calculateEMAValue(List<Candlestick> candlestickList){
        ...
        int maValuesIndex = 0;
        for (int i = (int) this.candlesticksQuantity; i < candlestickList.size() ; i++) {
            ...
            //return current candlesticksQuantity EMA value
    ...
    private void setMultiplier(){
        // calculate multiplier (2 / candlesticksQuantity + 1)
     ...
     * @return {@link BigDecimal} sma value for the chosen candlesticksQuantity and candlestickPriceType
     * @see Candlestick
     */
