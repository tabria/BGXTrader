...
/**
 * Class for opening new market if touched orders. The order will be created if there is tradable trade, generated by the system. To open new order, active trades must be zero and order, waiting to be fill, must be zero.
 */
