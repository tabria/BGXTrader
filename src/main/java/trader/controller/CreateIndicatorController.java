...
//    public CreateIndicatorController(RequestBuilder requestBuilder, UseCaseFactory useCaseFactory, Observable priceObservable, TradingStrategyConfiguration configuration, BrokerGateway gateway) {
