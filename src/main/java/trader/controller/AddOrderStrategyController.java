...
public class AddOrderStrategyController<T> implements TraderController<T> {

    private RequestOLDBuilder requestOLDBuilder;
    private UseCaseFactory useCaseFactory;

    public AddOrderStrategyController(RequestOLDBuilder requestOLDBuilder, UseCaseFactory useCaseFactory) {
