...
//        requestOLDBuilder.build("CreateExitStrategyController", settings);
//    }
//
//    @Test(expected = NullArgumentException.class)
...
//        Request<?> exitStrategyRequest = requestOLDBuilder.build("CreateExitStrategyController", settings);
