...
//    }
    ...
    public List<Candlestick> getFakeCandlestickListFullOfMock() {
        fillCandlestickList();
        return candlestickList;
    }

    public List<Candlestick> getFakeCandlestickListFullOfZeros() {
        fillCandlestickListWithZeros();
        return candlestickList;
    }
    ...
    protected void setCandlestickDateTime(Candlestick candlestick, int candlestickNumber) {
...
//    }
    ...
    protected Candlestick setCandlestickPrice(Candlestick candlestick, int candlestickNumber) {
