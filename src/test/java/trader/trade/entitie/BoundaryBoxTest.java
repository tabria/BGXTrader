...
//        String expected = String.format("WeightedMovingAverage{candlesticksQuantity=%d, appliedPrice=%s, indicatorValues=[], points=[], isTradeGenerated=false}", this.candlesticksQuantity, this.mockAppliedPrice.toString());
