...
//
//public class ServiceExitStrategyTest {
//
...
//
//        this.serviceExitStrategy = new ServiceExitStrategy(this.mockContext, this.candlestickGranularity);
//    }
//
//    @Test(expected = NullPointerException.class)
//    public void WhenCreateBaseExitStrategyWithNullContextThenException(){
//        new ServiceExitStrategy(null, this.candlestickGranularity);
//    }
//
//    @Test(expected = NullPointerException.class)
//    public void WhenCreateBaseExitStrategyWithNullCandlestickGranularityThenException(){
//        new ServiceExitStrategy(this.mockContext, null);
//    }
//
...
//        BigDecimal result = this.serviceExitStrategy.getLastFullCandleHigh();
//    }
//
//    @Test
...
//        //candlestickList is empty and required number of candlestick is 2
//        BigDecimal result = this.serviceExitStrategy.getLastFullCandleLow();
//    }
//
//    @Test
...
// //       when(this.mockCandlesUpdater.getCandles()).thenReturn(this.candlestickList);
//
//        BigDecimal result = this.serviceExitStrategy.getLastFullCandleClose();
//
...
//        boolean result = this.serviceExitStrategy.updaterUpdateCandles(this.mockDateTime);
//        assertTrue(result);
//    }
//
//    @Test
...
//        this.serviceExitStrategy.changeStopLoss(null, BigDecimal.ONE);
//    }
//
//    @Test(expected = NullPointerException.class)
//    public void WhenChangeStopLossWithNullNewStopPriceThenException(){
//        this.serviceExitStrategy.changeStopLoss(this.mockTradeID, null);
//    }
//
//    @Test
//    public void WhenChangeStopLossWithCorrectValuesThenReturnResponse(){
//        TradeSetDependentOrdersResponse tradeSetDependentOrdersResponse = this.serviceExitStrategy.changeStopLoss(this.mockTradeID, BigDecimal.TEN);
//
...
//        this.serviceExitStrategy.getStopLossOrderPriceByID(null, this.mockOrderID);
//    }
//
//    @Test(expected = NullPointerException.class)
//    public void WhenGetStopLossOrderPriceByIDWithNullOrderIdThenException(){
//        this.serviceExitStrategy.getStopLossOrderPriceByID(this.mockAccount, null);
//    }
//
//    @Test
...
//        BigDecimal stopLossOrderPriceByID = this.serviceExitStrategy.getStopLossOrderPriceByID(this.mockAccount, this.mockOrderID);
...
//        this.serviceExitStrategy.partialTradeClose(null, BigDecimal.ONE);
//    }
//
//    @Test(expected = NullPointerException.class)
//    public void WhenPartialTradeCloseWithNullPartsThenException(){
//        this.serviceExitStrategy.partialTradeClose(BigDecimal.ONE, null);
//    }
//
//    @Test(expected = IllegalArgumentException.class)
//    public void WhenPartialTradeCloseWithZeroPartsThenException(){
//        this.serviceExitStrategy.partialTradeClose(BigDecimal.TEN, BigDecimal.ZERO);
//    }
//
//    @Test
//    public void WhenPartialTradeCloseThenReturnCorrectResult(){
//
//        OrderCreateResponse orderCreateResponse = this.serviceExitStrategy.partialTradeClose(BigDecimal.TEN, BigDecimal.ONE);
//
...
//        this.serviceExitStrategy.getTrade(null);
//   }
//
//   @Test
//   public void WhenGetTradeThenReturnsCorrectResult(){
//       TradeSummary trade = this.serviceExitStrategy.getTrade(this.mockAccount);
//
//       assertSame(this.mockTrade, trade);
//   }
//
//    private void setCandlesUpdaterToMock() throws NoSuchFieldException, IllegalAccessException {
//        Field updater = this.serviceExitStrategy.getClass().getDeclaredField("candlesUpdater");
//        updater.setAccessible(true);
//        updater.set(this.serviceExitStrategy, this.mockCandlesUpdater);
//    }
//
