//package trader.exit.trailextreme;
//
...
//
//public class TrailExtremeExitStrategyTest {
//
...
//    private TrailExtremeExitStrategy trailExtremeExitStrategy;
...
//
//        this.trailExtremeExitStrategy = new TrailExtremeExitStrategy(this.mockContext, this.candlestickGranularity);
//
//    }
//
//    @Test
...
//
//        this.trailExtremeExitStrategy.execute(this.mockAccount, ask, bid, this.mockDateTime);
//
...
//        Field halfTradeResponse = this.trailExtremeExitStrategy.getClass().getDeclaredField("tradeSetDependentOrdersResponse");
//        halfTradeResponse.setAccessible(true);
//        return (TradeSetDependentOrdersResponse) halfTradeResponse.get(this.trailExtremeExitStrategy);
//
//    }
//
//    private void setBaseExitStrategyToMock() throws NoSuchFieldException, IllegalAccessException {
//        Field updater = this.trailExtremeExitStrategy.getClass().getDeclaredField("baseExitStrategy");
//        updater.setAccessible(true);
//        updater.set(this.trailExtremeExitStrategy, this.mockBaseExitStrategy);
//    }
//}