...
//        when(this.mockMA.nextCandleOpenTime(this.dateTime)).thenReturn(zd);
        ...
        this.wma = new WeightedMA(this.period, this.mockCandlestickPriceType, this.updater) ;
    ...
    public void WhenCallCreateThenReturnDifferenObject() {
        WeightedMA weightedMA = new WeightedMA(this.period, this.mockCandlestickPriceType, this.updater);
