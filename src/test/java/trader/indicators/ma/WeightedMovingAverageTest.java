...
//        when(this.mockMA.nextCandleOpenTime(this.dateTime)).thenReturn(zd);
        ...
        this.wma = new WeightedMovingAverage(this.period, this.mockCandlestickPriceType, this.updater) ;
    ...
    public void WhenCallCreateThenReturnDifferenObject() {
        WeightedMovingAverage weightedMovingAverage = new WeightedMovingAverage(this.period, this.mockCandlestickPriceType, this.updater);

        assertNotEquals("Objects must not be equal ",this.wma, weightedMovingAverage);
    }
    ...
    public void TestToString(){
        ...
        String expected = String.format("WeightedMovingAverage{candlesticksQuantity=%d, candlestickPriceType=%s, maValues=[], points=[], isTradeGenerated=false}", this.period, this.mockCandlestickPriceType.toString());
